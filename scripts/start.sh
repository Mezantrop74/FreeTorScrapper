...
(
cd $BASEDIR/init
echo "--- Shutdown services (haproxy, tor, delegate) ---"
./down_proxy.sh
...
echo "curl --socks5-hostname 127.0.0.1:9058 http://darknt2vpswmwp5u.onion/"
echo "curl --proxy 127.0.0.1:3129 http://darknt2vpswmwp5u.onion/"
echo "curl --proxy 127.0.0.1:3126 http://darknt2vpswmwp5u.onion/"
)
